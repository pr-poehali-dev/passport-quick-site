...
const faq = [
  ...
  {
    q: 'Сколько стоит помощь в оформлении загранпаспорта под ключ?',
    a: 'Стоимость зависит от срочности: от 26 000 ₽ при стандартном оформлении через МФЦ (12–24 рабочих дня) до 100 500 ₽ при максимально срочном варианте (от 4 рабочих дней). Госпошлина уже включена в цену.',
  },
  {
    q: 'Можно ли оформить загранпаспорт за 1 день?',
    a: 'Официальный регламент МВД не предусматривает выдачу загранпаспорта за один день. Минимальный реальный срок с нашей помощью — от 4 рабочих дней при срочном тарифе, отсчёт идёт со следующего дня после подачи документов.',
  },
  {
    q: 'Чем отличается срочное оформление от обычного через МФЦ?',
    a: 'Срочное оформление даёт готовый паспорт от 4 рабочих дней за более высокую цену — от 65 500 ₽. Стандартное оформление через МФЦ дешевле (от 26 000 ₽), но занимает от 12 до 24 рабочих дней.',
  },
  {
    q: 'Нужно ли мне лично присутствовать в МФЦ при подаче документов?',
    a: 'Да, заявитель подаёт документы и проходит биометрию лично — это требование МВД. Мы берём на себя подготовку документов, запись на удобное время и сопровождение, чтобы визит занял минимум времени.',
  },
  {
    q: 'В каком городе вы помогаете оформить загранпаспорт?',
    a: 'Мы оказываем содействие в оформлении загранпаспортов через МФЦ Москвы, а также помогаем иногородним заявителям — подробнее на странице для тех, кто без московской прописки.',
  },
];
      ...
      <JsonLd
        data={[
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'HowTo',
            name: 'Как оформить загранпаспорт через МФЦ',
            description:
              'Пошаговый порядок оформления загранпаспорта через МФЦ с нашей помощью — от записи до получения готового документа.',
            totalTime: 'P4D',
            step: [
              {
                '@type': 'HowToStep',
                name: 'Предварительная запись',
                text: 'Записываем вас в офис, готовим полный пакет документов и заключаем договор.',
              },
              {
                '@type': 'HowToStep',
                name: 'Договор и оплата',
                text: 'Вносите 100% предоплату наличными, после чего мы записываем вас в МФЦ на удобную дату.',
              },
              {
                '@type': 'HowToStep',
                name: 'Подача документов в МФЦ',
                text: 'В назначенный день вы подаёте документы лично. Отсчёт рабочих дней идёт со следующего дня после подачи.',
              },
              {
                '@type': 'HowToStep',
                name: 'Получение готового паспорта',
                text: 'По истечении срока сообщаем о готовности — паспорт получаете там же, где подавали документы.',
              },
            ],
          },
        ]}
      ...
      <section className="bg-secondary py-16 md:py-24">
        <div className="container max-w-3xl">
          <header className="text-center">
            ...
            <h2 className="mt-2 font-display text-3xl font-bold text-primary md:text-4xl">
              Опыт оформления загранпаспортов
            </h2>
          </header>
          <div className="mt-8 space-y-4 text-lg leading-relaxed text-foreground/85">
            <p>
              Мы специализируемся именно на содействии в оформлении загранпаспортов через МФЦ — для
              взрослых, детей, иногородних заявителей и тех, кому нужно уложиться в сжатые сроки.
              Знаем регламенты МВД, типичные причины отказов и как их избежать ещё на этапе
              подготовки документов.
            </p>
            <p>
              Перед подачей лично проверяем каждый документ и фотографии на соответствие
              требованиям, записываем на удобное время в МФЦ и сопровождаем клиента до получения
              готового паспорта. Работаем официально, по договору, с фиксированной ценой без скрытых
              доплат.
            </p>
          </div>
        </div>
